...
/*
un array es un puntero. este contienen la dirección de memoria de su primer elemento.

Como un array se almacena secuencialmente en la memoria RAM, solo se pone la direccion + el elemento a avanzar.
*/